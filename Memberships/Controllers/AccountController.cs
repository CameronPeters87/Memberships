...
namespace Memberships.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            // Instansiate a new list of users
        ...
        public async Task<ActionResult> Create(UserViewModel model)
        {
            if (ModelState.IsValid)
            {
                // Create new ApplicationUser and assign
                var user = new ApplicationUser
                {
                    UserName = model.Email,
                    Email = model.Email,
                ...
                // Add the user to UserManger
                var result = await UserManager.CreateAsync(user, model.Password);
                // If result Succeeded, return to index
                if (result.Succeeded)
                {
        ...
        public async Task<ActionResult> RemoveUserSubscription(string userId, int subscriptionId)
        {
            try
            {
                ...
                {
                    var db = new ApplicationDbContext();
                    var subs = db.UserSubscriptions.Where(us => us.UserId.Equals(userId) &&
